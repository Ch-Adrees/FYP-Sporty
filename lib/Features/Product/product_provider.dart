...
class ProductNotifier extends StateNotifier<List<Products>> {
  ...
  Future<List<String>> uploadImagesToDatabase(
    ...
    try {
      ...
      {
        Reference storageReference = storage.ref().child('images/productsImages/${DateTime.now().millisecondsSinceEpoch}.jpg');
  ...
  Future<void> uploadProductToFirebase(Products product) async {}
}
