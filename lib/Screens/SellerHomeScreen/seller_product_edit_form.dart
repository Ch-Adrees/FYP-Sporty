...
class EditProductsForm extends ConsumerStatefulWidget {
  const EditProductsForm({super.key, required this.productCode});

  final int productCode;
  @override
  EditProductsFormState createState() => EditProductsFormState();
}

class EditProductsFormState extends ConsumerState<EditProductsForm> {
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              await ref.read(productProvider.notifier).updateProductData(
                  context,
                  productTitleController.text.toString(),
